...
import '../../../domain/usecase/auth_use_case_domain.dart';
import '../../../domain/usecase/shared_prefences_use_case.dart';
...
abstract class NotificationRemoteDataSource {
  ...
  Future<bool> sendNotification(
      {required String message, required String token, required String title});
}
...
//305
  ...
  Future<bool> sendNotification(
    ...
    try {
      ...
      final sendMessage =
          await http.post(Uri.parse(url), body: jsonEncode(_body), headers: {
